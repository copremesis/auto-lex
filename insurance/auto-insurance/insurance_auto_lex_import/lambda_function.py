...
def import_lex_bot(roleArn, bot_name, lambda_function_name):
    ...
    # Step 1.1: Updating the voiceId to 'Joanna'
...
# import_lex_bot('arn:aws:iam::049982172265:role/aws-service-role/lexv2.amazonaws.com/AWSServiceRoleForLexV2Bots_QV0YH7IDOM', 'KT1237', 'HospitalityAirline')
# --- Main handler ---
